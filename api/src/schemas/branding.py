...
class BrandingResponse(BaseModel):
    ...
    apple_touch_icon_url: str = Field(..., description="Apple touch icon URL for home screen shortcuts.")
    manifest_url: str = Field(..., description="Manifest URL for PWA configuration.")
