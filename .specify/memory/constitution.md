...
2. Implementation plan at `specs/###-feature-name/plan.md` with Constitution Check gates before research and after design
3. Phase outputs (research, data-model, quickstart, contracts) generated via the plan workflow
4. Task breakdown at `specs/###-feature-name/tasks.md` created via the tasks command and executed with TDD
